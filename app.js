...
function editProduct(e){
  ...
  parentItem.childNodes[11].innerHTML = `<button onClick="updateProduct(event)">Save</button>`
  parentItem.childNodes[13].innerHTML = `<button onClick="getProducts(products)">Cancel</button>`
}
// delete product 
